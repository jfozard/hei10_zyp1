...
def generate_figure(input_sim_prefix, output_fn):
    ...
    g = make_single((extra_panels_path + 'recycling_model_new_CM2.svg', None))
...
generate_figure(extra_panels_path, output_path+'fig1.svg')
run(['inkscape', '-D', '-d', '300',  output_path+'fig1.svg', '-o', output_path+'fig1.png'])
run(['inkscape', '-D', '-d', '300',  output_path+'fig1.svg', '-o', output_path+'fig1.pdf'])
