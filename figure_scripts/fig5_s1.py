...
def generate_figure(input_sim_prefix, output_fn):
    ...
    g = make_single((extra_panels_path + 'model_pch2_only_diagram.svg', None))
...
generate_figure(extra_panels_path, output_path+'fig5_s1.svg')
run(['inkscape', '-D', '-d', '300',  output_path+'fig5_s1.svg', '-o', output_path+'fig5_s1.png'])
run(['inkscape', '-D', '-d', '300',  output_path+'fig5_s1.svg', '-o', output_path+'fig5_s1.pdf'])
